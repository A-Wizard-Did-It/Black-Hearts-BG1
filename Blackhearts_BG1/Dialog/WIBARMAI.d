...
CHAIN IF ~Global("IllaseraScene1","GLOBAL",2)~ THEN WIBARMAI WIBarmaid5
	@213 
END
		+ ~Global("WIRubyWine","AR3351",1)~ + @214 + WIBarmaid6
		+ ~Global("WIBerduskan","AR3351",1)~ + @215 + WIBarmaid7
		+ ~Global("WIEvermead","AR3351",1)~ + @216 + WIBarmaid8
		+ ~Global("WIFeldTea","AR3351",1)~ + @217 + WIBarmaid9
		+ ~Global("WIFeldAle","AR3351",1)~ + @218 + WIBarmaid10
		+ ~Global("WIFeldWater","AR3351",1)~ + @219 + WIBarmaid11
