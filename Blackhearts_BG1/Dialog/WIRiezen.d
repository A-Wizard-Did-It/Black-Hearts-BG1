...
CHAIN WIRiezen ri9.4
	@3240 DO ~SetGlobal("BHBG1Quest","GLOBAL",10) Enemy() StartCutSceneMode() StartCutSceneEx("WIcuts12",TRUE)~ EXIT
...
CHAIN WIRiezen ri9.6
	@3251
	== NEERAJ IF ~InParty("Neera") InMyArea("Neera") !StateCheck("Neera",CD_STATE_NOTVALID)~ THEN @3252
END
		++ @3253 + ri9.9
		++ @3254 + ri9.5
		++ @3247 + ri9.7
