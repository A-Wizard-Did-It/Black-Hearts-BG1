...
CHAIN EDWINJ BHEdwinInt3
	@2661 EXTERN WIREDWIZ WIREDWIZ1

CHAIN EDWINJ BHEdwinInt4
...
CHAIN IMOEN2 BHImoenPub2
	@2681 EXTERN WIillase il15.97

CHAIN IMOEN2 BHImoenPub3
	@2682 EXTERN WIillase il15.97

CHAIN IMOEN2 BHImoenPub4
	@2683 EXTERN WIillase il15.97
	
CHAIN IMOEN2 BHImoenPub5
	@2684 EXTERN WIillase il15.97
	
CHAIN IMOEN2 BHImoenPub6
	@2685 EXTERN WIillase il15.97

CHAIN IMOEN2 BHImoenPub7
	@2686
	= @2687
END
		++ @2688 + BHImoenPub8
...
CHAIN IMOEN2 BHImoenPub8
	@2692 EXTERN IMOEN2 BHImoenPub12

CHAIN IMOEN2 BHImoenPub9
	@2693 EXTERN IMOEN2 BHImoenPub12

CHAIN IMOEN2 BHImoenPub10
	@2694 EXTERN IMOEN2 BHImoenPub12

CHAIN IMOEN2 BHImoenPub11
	@2695 EXTERN IMOEN2 BHImoenPub12

CHAIN IMOEN2 BHImoenPub12
	@2696 EXTERN WIillase il15.102

CHAIN IMOEN2 BHImoenPub13
	@2697 EXTERN WIillase il15.103

CHAIN IMOEN2 BHImoenPub14
	@2698
	= @2699 EXTERN WIillase il15.104

CHAIN IMOEN2 BHImoenPub16
	@2700 EXTERN WIillase il15.105

CHAIN IMOEN2 BHImoenPub17
	@2701
END
	++ @2702 + BHImoenPub18
	++ @2703 + BHImoenPub19
...
CHAIN IMOEN2 BHImoenPub18
	@2726 EXTERN WIillase il15.106

CHAIN IMOEN2 BHImoenPub19
	@2727 EXTERN WIillase il15.106
	
CHAIN IMOEN2 BHImoenPub20
	@2728 EXTERN WIillase il15.106
	
CHAIN IMOEN2 BHImoenPub21
	@2729 EXTERN WIillase il15.106
	
CHAIN IMOEN2 BHImoenPub22
	@2730 EXTERN WIillase il15.106
	
CHAIN IMOEN2 BHImoenPub23
	@2731 EXTERN WIillase il15.106

CHAIN IMOEN2 BHImoenPub24
...
+ ~Global("BHBG1Quest","GLOBAL",13) PartyHasItem("WIAMUL02")~ + @2782 + WIALATOS12
END
...
IF ~~ THEN BEGIN WIALATOS8
	SAY @2807 IF ~~ THEN DO ~TakePartyGold(3000) SetGlobal("BHBG1QuestTHF","GLOBAL",1)~ + WIALATOS9
END
