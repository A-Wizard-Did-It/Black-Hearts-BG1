...
CHAIN IF ~Global("WINerysMet","GLOBAL",0) Global("BHBG1Quest","GLOBAL",8)~ THEN WInerys ne8.0
	@2905
	== MINSCJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @2906
...
CHAIN IF ~Global("WINerysMet","GLOBAL",1) Global("BHBG1Quest","GLOBAL",8)~ THEN WInerys ne8.8
	...
	== NEERAJ IF ~InParty("Neera") InMyArea("Neera") !StateCheck("Neera",CD_STATE_NOTVALID)~ THEN @2919
END
		++ @2920 + ne8.9
		++ @2921 + ne8.10
		++ @2922 + ne8.11
...
CHAIN WInerys ne8.16
	@2947
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2948
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2949
END
		++ @2950 + ne8.19
		++ @2951 + ne8.19
