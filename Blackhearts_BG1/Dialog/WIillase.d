...
CHAIN IF ~IsGabber("Dorn") GlobalGT("BHBG1Quest","GLOBAL",6) Global("IllaDornBanter","GLOBAL",1)~ THEN WIillase ilDo2
	...
	== DORNJ @742
	== WIillase @743
	== DORNJ @744 DO ~SetGlobal("IllaDornBanter","GLOBAL",2)~ EXIT	
...
CHAIN IF ~IsGabber("Edwin") GlobalGT("BHBG1Quest","GLOBAL",1) Global("IllaEdwinBanter","GLOBAL",0)~ THEN WIillase ilEd1
	...
	== EDWINJ @772
	== WIillase @773
	== EDWINJ @774 DO ~SetGlobal("IllaEdwinBanter","GLOBAL",1)~ EXIT
...
CHAIN IF ~IsGabber("Edwin") GlobalGT("BHBG1Quest","GLOBAL",16) Global("IllaEdwinBanter","GLOBAL",2)~ THEN WIillase ilEd3	
	...
	== EDWINJ @789
	== WIillase @790
	== EDWINJ @791 DO ~SetGlobal("IllaEdwinBanter","GLOBAL",3)~ EXIT	
...
CHAIN IF ~IsGabber("Imoen") GlobalGT("BHBG1Quest","GLOBAL",1) Global("IllaImoenBanter","GLOBAL",0)~ THEN WIillase ilIm1
	@857
	== IMOEN2 @858
	== WIillase @859
	== IMOEN2 @860
...
CHAIN IF ~IsGabber("Imoen") GlobalGT("BHBG1Quest","GLOBAL",6) Global("IllaImoenBanter","GLOBAL",1)~ THEN WIillase ilIm2
	@869
	== IMOEN2 @870
	== WIillase @871
	== IMOEN2 @872
	...
	== IMOEN2 @878
	== WIillase @879
	== IMOEN2 @880 DO ~SetGlobal("IllaImoenBanter","GLOBAL",2)~ EXIT

CHAIN IF ~IsGabber("Imoen") GlobalGT("BHBG1Quest","GLOBAL",16) Global("IllaImoenBanter","GLOBAL",2)~ THEN WIillase ilIm3
	@881
	== IMOEN2 @882
	== WIillase @883
	== IMOEN2 @884
...
CHAIN IF ~IsGabber("Neera") GlobalGT("BHBG1Quest","GLOBAL",1) Global("IllaNeeraBanter","GLOBAL",0)~ THEN WIillase ilNe1
	...
	== NEERAJ @1007
	== WIillase 1008
	== NEERAJ @1009 DO ~SetGlobal("IllaNeeraBanter","GLOBAL",1)~ EXIT
...
CHAIN IF ~IsGabber("Neera") GlobalGT("BHBG1Quest","GLOBAL",6) Global("IllaNeeraBanter","GLOBAL",1)~ THEN WIillase ilNe2
	...
	== NEERAJ @1015
	== WIillase @1016
	== NEERAJ @1017 DO ~SetGlobal("IllaNeeraBanter","GLOBAL",2)~ EXIT
...
CHAIN IF ~IsGabber("Neera") GlobalGT("BHBG1Quest","GLOBAL",16) Global("IllaNeeraBanter","GLOBAL",2)~ THEN WIillase ilNe3
	...
	== NEERAJ @1021
	== WIillase @1022
	== NEERAJ @1023 DO ~SetGlobal("IllaNeeraBanter","GLOBAL",3)~ EXIT
...
CHAIN IF ~IsGabber("Safana") GlobalGT("BHBG1Quest","GLOBAL",6) Global("IllaSafanaBanter","GLOBAL",1)~ THEN WIillase ilSa2
	...
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @1079
...
CHAIN IF ~InMyArea("Safana") GlobalGT("BHBG1Quest","GLOBAL",6) Global("IllaSafanaBanter","GLOBAL",2)~ THEN WIillase ilSa3
	...
	== SAFANJ @1082
	== WIillase @1083
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @1084
	== SAFANJ @1085
	== WIillase @1086
	== SAFANJ @1087
...
CHAIN IF ~IsGabber("Xan") GlobalGT("BHBG1Quest","GLOBAL",6) Global("IllaXanBanter","GLOBAL",1)~ THEN WIillase ilXa2
	...
	== WIillase @1173
	== XANJ @1174
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @1175
	== WIillase @1176
...
CHAIN IF ~NumTimesTalkedTo(0) !Dead("Marl") GlobalLT("Chapter","GLOBAL",3)~ THEN WIillase il0.1
	@1214
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @1215
	== WIillase IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @1216
END
		++ @1217 + il0.5
		++ @1218 + il0.6
...
CHAIN WIillase il0.25
	@1295
	== IMOEN2 IF ~InParty("Imoen")~ THEN @1296
END	
		++ @1297 + il0.26
		++ @1298 + il0.26
		++ @1299 + il0.26
...
CHAIN WIillase il0.31
	@1317
	== NEERAJ IF ~InParty("Neera") InMyArea("Neera") !StateCheck("Neera",CD_STATE_NOTVALID)~ THEN @1318
END
		++ @1319 + il0.32
		++ @1320 + il0.17
		++ @1321 + il0.20
...
CHAIN IF ~NumTimesTalkedTo(0) GlobalGT("Chapter","GLOBAL",2) GlobalLT("Chapter","GLOBAL",5)~ THEN WIillase il1.0
	@1326
	== MINSCJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @1327
...
CHAIN WIillase il1.1
	@1332
	= @1333
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @1334
END	
		++ @1335 + il1.4
		++ @1336 + il1.4
		++ @1337 + il1.5
...
CHAIN WIillase il1.5
	@1345
	== RASAADJ IF ~InParty("Rasaad") InMyArea("Rasaad") !StateCheck("Rasaad",CD_STATE_NOTVALID)~ THEN @1346
...
CHAIN WIillase il1.15
	...
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID) InParty("Garrick") InMyArea("Garrick") !StateCheck("Garrick",CD_STATE_NOTVALID)~ THEN @1394
	== GARRIJ IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID) InParty("Garrick") InMyArea("Garrick") !StateCheck("Garrick",CD_STATE_NOTVALID)~ THEN @1395
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID) InParty("Garrick") InMyArea("Garrick") !StateCheck("Garrick",CD_STATE_NOTVALID)~ THEN @1396
END
		++ @1397 + il1.16
		++ @1398 + il1.17
		++ @1399 + il1.18
...
CHAIN IF ~Global("BHBG1Quest","GLOBAL",1) PartyHasItem("WIHELM01")~ THEN WIillase il2.0
	@1421
	== MINSCJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @1422
	== DORNJ IF ~InParty("Dorn") InMyArea("Dorn") !StateCheck("Dorn",CD_STATE_NOTVALID)~ THEN @1423
...
CHAIN WIillase il3.1
	@1487
	== RASAADJ IF ~InParty("Rasaad") InMyArea("Rasaad") !StateCheck("Rasaad",CD_STATE_NOTVALID)~ THEN @1488
	== WIillase IF ~InParty("Rasaad") InMyArea("Rasaad") !StateCheck("Rasaad",CD_STATE_NOTVALID)~ THEN @1489
	== RASAADJ IF ~InParty("Rasaad") InMyArea("Rasaad") !StateCheck("Rasaad",CD_STATE_NOTVALID)~ THEN @1490
END	
		++ @1491 + il3.2
...
CHAIN WIillase il4.6
	@1554
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @1555
END
		++ @1548 + il4.7
		++ @1549 + il4.8
...
CHAIN WIillase il4.8
	...
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @1559
END
		++ @1560 + il4.7
		++ @1561 + il1.8
...
CHAIN WIillase il4.10
	@1569
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @1570
END
		++ @1571 + il4.11
		++ @1566 + il4.14
		++ @1567 + il4.15
...
CHAIN WIillase il4.19
	@1585
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @1586
END
		++ @1587 + il4.20
		++ @1588 + il4.21
...
CHAIN WIillase il4.23
	@1594
	== RASAADJ IF ~InParty("Rasaad") InMyArea("Rasaad") !StateCheck("Rasaad",CD_STATE_NOTVALID)~ THEN @1595
...
CHAIN WIillase il4.24
	...
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @1600
END
		++ @1601 + il4.25
		++ @1602 + il4.25
...
CHAIN WIillase il5.1
	@1616
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @1617
	== WIillase @1618
END
		++ @1612 + il5.2
		++ @1613 + il5.3
...
CHAIN WIillase il5.3
	...
	== DORNJ IF ~InParty("Dorn") InMyArea("Dorn") !StateCheck("Dorn",CD_STATE_NOTVALID)~ THEN @1624
	== WIillase @1625
END
		++ @1611 + il5.1
		++ @1612 + il5.2
...
CHAIN WIillase il5.11
	@1646
	== DORNJ IF ~InParty("Dorn") InMyArea("Dorn") !StateCheck("Dorn",CD_STATE_NOTVALID)~ THEN @1647
...
CHAIN WIillase il5.21
	@1674 DO ~AddJournalEntry(@65,QUEST) SetGlobal("BHBG1Quest","GLOBAL",6) CreateVisualEffectObject("spdimndr",myself) MoveBetweenAreas("AR0705",[419.873],6)~ EXIT

CHAIN WIillase il5.22
	@1675 DO ~AddJournalEntry(@65,QUEST) SetGlobal("BHBG1Quest","GLOBAL",6) CreateVisualEffectObject("spdimndr",myself) MoveBetweenAreas("AR0705",[419.873],6)~ EXIT
...
CHAIN WIillase il6.1
	@1688 DO ~SetGlobal("WIRubyWine","AR3351",1)~ EXTERN WIBARMAI WIBarmaid4

CHAIN WIillase il6.2
	@1689 DO ~SetGlobal("WIBerduskan","AR3351",1)~ EXTERN WIBARMAI WIBarmaid4
	
CHAIN WIillase il6.3
	@1690
	= @1691 DO ~SetGlobal("WIEvermead","AR3351",1)~ EXTERN WIBARMAI WIBarmaid4

CHAIN WIillase il6.4
	@1692 DO ~SetGlobal("WIFeldTea","AR3351",1)~ EXTERN WIBARMAI WIBarmaid4
	
CHAIN WIillase il6.5
	@1693 DO ~SetGlobal("WIFeldAle","AR3351",1)~ EXTERN WIBARMAI WIBarmaid4

CHAIN WIillase il6.6
	@1694 DO ~SetGlobal("WIFeldWater","AR3351",1)~ EXTERN WIBARMAI WIBarmaid4
...
CHAIN WIillase il6.95
	@1952 DO ~SetGlobal("IllaseraScene1","GLOBAL",4) AddJournalEntry(@65,QUEST) SetGlobal("IllaseraFriendship","GLOBAL",1) CreateVisualEffectObject("spdimndr",myself) MoveBetweenAreas("AR0705",[419.873],6)~ EXIT
	
CHAIN WIillase il6.96
	@1953 DO ~SetGlobal("IllaseraScene1","GLOBAL",4) AddJournalEntry(@65,QUEST) SetGlobal("IllaseraFriendship","GLOBAL",1) CreateVisualEffectObject("spdimndr",myself) MoveBetweenAreas("AR0705",[419.873],6)~ EXIT
	
CHAIN WIillase il6.97
	@1954 DO ~SetGlobal("IllaseraScene1","GLOBAL",4) AddJournalEntry(@65,QUEST) SetGlobal("IllaseraFriendship","GLOBAL",1) CreateVisualEffectObject("spdimndr",myself) MoveBetweenAreas("AR0705",[419.873],6)~ EXIT
...
CHAIN WIillase il6.99
	@1958
END
		+ ~!InParty("Imoen")~ + @1959 + il6.100
		+ ~InParty("Imoen")~ + @1960 + il6.101
		++ @1961 + il6.102
		++ @1962 + il6.103
		++ @1963 + il6.102
...
CHAIN IF ~Global("BHBG1Quest","GLOBAL",6) Global("IllaseraFriendship","GLOBAL",1)~ THEN WIillase il7.1
	@2003
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2004
END
		++ @2005 + il7.4
		++ @2006 + il7.5
		++ @2007 + il7.6
...
CHAIN WIillase il7.2
	@2009
	== NEERAJ IF ~InParty("Neera") InMyArea("Neera") !StateCheck("Neera",CD_STATE_NOTVALID)~ THEN @2010
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @2011
	== WIillase @2012
END
		+ ~CheckStatGT(Player1,14,INT)~ + @2013 EXTERN WIREDWIZ WIREDWIZ2
		+ ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ + @2014 EXTERN EDWINJ BHEdwinInt3
...
CHAIN WIillase il7.20
	@2058
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @2059
...
CHAIN WIillase il8.2
	@2115
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @2116
END
		++ @2117 + il8.5
		++ @2118 + il8.7
		++ @2119 + il8.5
...
CHAIN IF ~Global("BHBG1Quest","GLOBAL",12)~ THEN WIillase il12.0
	@2154
	== DORNJ IF ~InParty("Dorn") InMyArea("Dorn") !StateCheck("Dorn",CD_STATE_NOTVALID)~ THEN @2155
END
		++ @2156 + il12.1
		++ @2157 + il12.2
...
CHAIN WIillase il12.2
	@2161
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2162
END
		++ @2163 + il12.4
...
CHAIN WIillase il12.8
	@2177
	== MINSCJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @2178
END
		++ @2166 + il12.6
		++ @2167 + il12.7
		++ @2168 + il12.7
...
CHAIN WIillase il15.13
	...
	= @2220
	= @2221
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @2222
END
		++ @2223 + il15.14
		++ @2224 + il15.14
...
CHAIN WIillase il15.15
	@2232
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2233
END
		++ @2234 + il15.16
		++ @2235 + il15.18
...
CHAIN WIillase il15.94
	@2444
END
		+ ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ + @2445 + il15.95
		+ ~!InParty("Imoen") !InMyArea("Imoen")~ + @2446 + il15.97
...
CHAIN IF ~Global("BHBG1ImoenJoin","GLOBAL",1) Global("IllaseraScene2","GLOBAL",1)~ THEN WIillase il15.96
	@2448 EXTERN IMOEN2 BHImoenPub1

CHAIN WIillase il15.97
	@2449
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2450
END
		++ @2451 + il15.99
		++ @2452 + il15.99
		++ @2453 + il15.99
...
CHAIN WIillase il15.98
	@2459
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2460
	== WIillase IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2461
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2462 EXTERN WIillase il15.97

CHAIN WIillase il15.99
	@2463
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2464
	== WIillase IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2465
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2466
	== WIillase IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2467
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2468
	== WIillase IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2469
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2470
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2471
END
		+ ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ + @2472 EXTERN IMOEN2 BHImoenPub7
		+ ~!InParty("Imoen") !InMyArea("Imoen")~ + @2473 + il15.101
		
CHAIN WIillase il15.100
	@2474
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2475
	== WIillase IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2476
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2477
	== WIillase IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2467
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2468
	== WIillase IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2469
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2470
...
CHAIN WIillase il15.102
	@2479 EXTERN IMOEN2 BHImoenPub13

CHAIN WIillase il15.103
	@2480 EXTERN IMOEN2 BHImoenPub14

CHAIN WIillase il15.104
	@2481 EXTERN IMOEN2 BHImoenPub16

CHAIN WIillase il15.105
	@2482 EXTERN IMOEN2 BHImoenPub17

CHAIN WIillase il15.106
	@2483
END
		++ ~Well...~ EXTERN IMOEN2 BHImoenPub24
...
CHAIN WIillase il18.2
	@2554
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @2555
END
		++ @2556 + il18.7
		++ @2557 + il18.8
		++ @2558 + il18.9
...
CHAIN IF ~Global("BHBG1Quest","GLOBAL",21) NumTimesTalkedTo(0)~ THEN WIillase il19.0
	@2594
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2595
	== WIILLASE IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @2596
END
		++ @2597 + il19.1
		++ @2598 + il19.2
		++ @2599 + il19.2
