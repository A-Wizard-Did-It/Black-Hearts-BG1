...
CHAIN IF ~NumTimesTalkedTo(0) Global("BHBG1Quest","GLOBAL",2)~ THEN WIELENAI WIelenai0
	@389
	== NEERAJ IF ~InParty("Neera") InMyArea("Neera") !StateCheck("Neera",CD_STATE_NOTVALID)~ THEN @390
END
		++ @391 + WIelenai1
		++ @392 + WIelenai2
...
CHAIN WIELENAI WIelenai6
	@413
	== MINSCJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @414
END
		++ @415 + WIelenai7
		++ @416 + WIelenai7
