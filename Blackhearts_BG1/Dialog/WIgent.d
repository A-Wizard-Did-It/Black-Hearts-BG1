...
CHAIN IF ~NumTimesTalkedTo(0)~ THEN WIgent ge4.0
	...
	== NEERAJ IF ~InParty("Neera") InMyArea("Neera") !StateCheck("Neera",CD_STATE_NOTVALID)~ THEN @485
	== MINSCJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @486
END
		++ @487 + ge4.1
		++ @488 + ge4.2
		++ @489 + ge4.3
...
CHAIN WIgent ge4.1
	@490
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @491
	== WIgent @492
	== RASAADJ IF ~InParty("Rasaad") InMyArea("Rasaad") !StateCheck("Rasaad",CD_STATE_NOTVALID)~ THEN @493
END
		++ @494 + ge4.4
		++ @495 + ge4.5
		++ @496 + ge4.6
...
CHAIN WIgent ge4.3
	@500
	== DORNJ IF ~InParty("Dorn") InMyArea("Dorn") !StateCheck("Dorn",CD_STATE_NOTVALID)~ THEN @501
...
CHAIN WIgent ge4.4
	@506
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @507
...
CHAIN WIgent ge4.7
	@522 DO ~Enemy() ApplySpell(Myself,WIZARD_INVISIBILITY) SetGlobal("BHBG1Quest4spawn","AR2700",2)~ EXIT
...
CHAIN WIgent ge4.9
	@527
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @528
	== WIgent IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @529
END
		++ @530 + ge4.13
		++ @531 + ge4.14
...
CHAIN WIgent ge4.11
	...
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @537
END
		++ @538 + ge4.17
...
CHAIN WIgent ge4.15
	...
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @559
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @560
END
		+ ~CheckStatLT(Player1,16,INT)~ + @561 + ge4.29
		+ ~CheckStatGT(Player1,15,INT)~ + @562 + ge4.30
		+ ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ + @563 EXTERN IMOEN2 BHImoenInt1
		+ ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ + @564 EXTERN EDWINJ BHEdwinInt1

CHAIN WIgent ge4.16
	@565 DO ~SetGlobal("GentleArgument2","LOCALS",1)~
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @566
	== EDWINJ IF ~InParty("Edwin") InMyArea("Edwin") !StateCheck("Edwin",CD_STATE_NOTVALID)~ THEN @567
END
		+ ~CheckStatLT(Player1,16,INT)~ + @561 + ge4.29
		+ ~CheckStatGT(Player1,15,INT)~ + @562 + ge4.30
		+ ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ + @563 EXTERN IMOEN2 BHImoenInt1
...
CHAIN WIgent ge4.42
	@628
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @629
	== WIgent @630
	= @631
END
		++ @632 + ge4.43
...
CHAIN WIgent ge4.43
	@633
	== IMOEN2 IF ~InParty("Imoen") InMyArea("Imoen") !StateCheck("Imoen",CD_STATE_NOTVALID)~ THEN @634
	== NEERAJ IF ~InParty("Neera") InMyArea("Neera") !StateCheck("Neera",CD_STATE_NOTVALID)~ THEN @635
	== WIgent @636
END
		++ @637 + ge4.44
		++ @638 + ge4.44
